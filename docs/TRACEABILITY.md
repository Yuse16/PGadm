...
- **Status**: **COMPLETED AND INTEGRATED** — merged into `develop` via PR #9 (merge commit `183b9b4`); closed by `docs/f1c-f1d-close-phase` (PR #11).
...
- **Status**: **COMPLETED AND INTEGRATED** — merged into `develop` via PR #10 (merge commit `719f5ac`); closed by `docs/f1c-f1d-close-phase` (PR #11).
...
- **Tests**: `supabase/tests/test_inventory_stock.sql` (88) + suites ajustadas a 15 permisos / 35 role_permissions → **638/638 SQL** (10 archivos); **388/388 app** (48 archivos); `e2e:auth` 14/14; `e2e:identity` 44/44.
