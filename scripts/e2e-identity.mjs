...
const MANAGER_PERMS = ["branch.read", "catalog.create", "catalog.read", "catalog.update", "inventory.approve", "inventory.import", "inventory.observe", "inventory.read", "layout.edit", "layout.publish", "layout.read", "organization.read", "organization.write", "sales.budget_manage", "sales.capture_own", "sales.cedis_request", "sales.edit_all", "sales.quote", "sales.read", "warehouse.read"];
const CASHIER_PERMS = ["branch.read", "catalog.read", "inventory.observe", "inventory.read", "layout.read", "organization.read", "sales.capture_own", "sales.cedis_request", "sales.quote", "sales.read"];
const OPERATOR_PERMS = ["catalog.read", "inventory.observe", "inventory.read", "layout.read", "organization.read", "sales.read"];
